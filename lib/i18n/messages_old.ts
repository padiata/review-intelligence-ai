...
export const messages = {
  es: {
    ...
    settingsPage: {
      ...
      description:
        "Administre la configuración transversal de Padiata y los modelos que dan soporte a la operación y a la inteligencia de la plataforma.",
      ...
      userProfiles: {
        ...
        description:
          "Configure capacidades, niveles de responsabilidad, criterios de perfilado y alcance operativo de los usuarios.",
      },
      ...
      taxonomies: {
        ...
        description:
          "Administre la estructura de Áreas, Causas y Subcausas utilizada por Review Understanding y los procesos de inteligencia.",
      },
    },
    ...
    taxonomiesPage: {
      ...
      description:
        "Consulte la estructura de Áreas, Causas y Subcausas utilizada por Review Understanding. En esta primera etapa la taxonomía se muestra en modo consulta.",

      domainLabel:
        "Dominio",

      domainAria:
        "Seleccionar dominio de taxonomía",
      ...
      noDomains:
        "No hay dominios activos disponibles.",

      searchPlaceholder:
        "Buscar por área, causa, subcausa o código...",
      ...
      areaCreate: {
        ...
        description:
          "Cree un área canónica para el dominio seleccionado. Padiata generará los códigos automáticamente.",
        ...
        codeHelp:
          "El código numérico sigue E AA 00 00. Ambos códigos quedan bloqueados después de crear el área.",
    ...
    reportsPage: {
      ...
      description:
        "Seleccione el período de las opiniones que desea analizar. El informe se generará bajo demanda a partir de los hallazgos disponibles.",

      periodTitle:
        "Período del informe",

      periodDescription:
        "El período se calcula mediante la fecha real de publicación de cada review.",
      ...
      preparingDescription:
        "Estamos organizando los hallazgos y redactando el informe ejecutivo. Este proceso puede tardar algunos segundos.",
      ...
      reportEyebrow:
        "Informe de inteligencia operativa",
      ...
      noFindings:
        "No se identificaron hallazgos relevantes para este período.",
      ...
      noPositiveAspects:
        "No se identificaron aspectos positivos específicos para este período.",
  ...
  en: {
    ...
    settingsPage: {
      ...
      description:
        "Manage Padiata's cross-platform configuration and the models that support operations and intelligence across the platform.",
      ...
      userProfiles: {
        ...
        description:
          "Configure user capabilities, responsibility levels, profiling criteria, and operational scope.",
      },
      ...
      taxonomies: {
        ...
        description:
          "Manage the Area, Cause, and Subcause structure used by Review Understanding and intelligence workflows.",
      },
    },
    ...
    taxonomiesPage: {
      ...
      description:
        "Review the Area, Cause, and Subcause structure used by Review Understanding. In this first stage, the taxonomy is displayed in read-only mode.",
      ...
      domainsLoadError:
        "The domains could not be loaded.",

      noDomains:
        "No active domains are available.",

      searchPlaceholder:
        "Search by area, cause, subcause, or code...",
      ...
      areaCreate: {
        ...
        description:
          "Create a canonical area for the selected domain. Padiata will generate the codes automatically.",
        ...
        codeHelp:
          "The numeric code follows E AA 00 00. Both codes are locked after the area is created.",

        generating:
          "Generating...",

        previewError:
          "The codes could not be generated.",

        requiredError:
          "Complete the area name.",
    ...
    reportsPage: {
      ...
      description:
        "Select the review period you want to analyze. The report will be generated on demand from the available findings.",

      periodTitle:
        "Report period",

      periodDescription:
        "The period is calculated using the actual publication date of each review.",
      ...
      preparingDescription:
        "We are organizing the findings and drafting the executive report. This process may take a few seconds.",
      ...
      noFindings:
        "No relevant findings were identified for this period.",
      ...
      noPositiveAspects:
        "No specific positive aspects were identified for this period.",
